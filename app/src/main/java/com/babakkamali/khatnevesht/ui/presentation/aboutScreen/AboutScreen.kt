package com.babakkamali.khatnevesht.ui.presentation.aboutScreen
...
fun AboutScreen(
    ...
    val intentLinkedIn = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.linkedin.com/in/babakkamali/"))
